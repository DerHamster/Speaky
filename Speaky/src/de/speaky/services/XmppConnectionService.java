...
import de.speaky.entities.Message;
import de.speaky.entities.MucOptions;
import de.speaky.entities.Presences;
import de.speaky.entities.MucOptions.OnRenameListener;
import de.speaky.generator.MessageGenerator;
import de.speaky.parser.MessageParser;
import de.speaky.parser.PresenceParser;
import de.speaky.persistance.DatabaseBackend;
import de.speaky.persistance.FileBackend;
import de.speaky.ui.OnAccountListChangedListener;
import de.speaky.ui.OnConversationListChangedListener;
import de.speaky.ui.UiCallback;
import de.speaky.utils.CryptoHelper;
import de.speaky.utils.ExceptionHelper;
import de.speaky.utils.OnPhoneContactsLoadedListener;
import de.speaky.utils.PRNGFixes;
import de.speaky.utils.PhoneHelper;
import de.speaky.utils.UIHelper;
import de.speaky.xml.Element;
import de.speaky.xmpp.OnBindListener;
import de.speaky.xmpp.OnContactStatusChanged;
import de.speaky.xmpp.OnIqPacketReceived;
import de.speaky.xmpp.OnMessagePacketReceived;
import de.speaky.xmpp.OnPresencePacketReceived;
import de.speaky.xmpp.OnStatusChanged;
import de.speaky.xmpp.OnTLSExceptionReceived;
import de.speaky.xmpp.XmppConnection;
import de.speaky.xmpp.jingle.JingleConnectionManager;
import de.speaky.xmpp.jingle.OnJinglePacketReceived;
...
//	}
	...
	public Message attachImageToConversation(final Conversation conversation,
		...
		//Log.d("SPEAKY","file: "+getPath(uri));
		//final String my_uri = getPath(uri);
