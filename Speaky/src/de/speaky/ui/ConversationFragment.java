...
import de.speaky.services.ImageProvider;
import de.speaky.services.XmppConnectionService;
import de.speaky.utils.UIHelper;
import de.speaky.xmpp.jingle.JingleConnection;
import net.java.otr4j.session.SessionStatus;
import de.speaky.speaky.R;
...
public class ConversationFragment extends Fragment {
	...
	public View onCreateView(final LayoutInflater inflater,
		...
		messageListAdapter = new ArrayAdapter<Message>(this.getActivity()
			...
			private void displayStatus(ViewHolder viewHolder, Message message) {
				...
				if (message.getEncryption() == Message.ENCRYPTION_NONE) {
					...
					if (message.getStatus() == Message.STATUS_SEND_RECEIVED) {
						//Log.d("SPEAKY", "MESSAGE RECEIVED");
						viewHolder.indicator.setVisibility(View.VISIBLE);
					} else if (message.getStatus() == Message.STATUS_SEND_DISPLAYED) {
						//Log.d("SPEAKY", "MESSAGE DISPLAYED");
						viewHolder.indicator.setVisibility(View.VISIBLE);
					} else {
						viewHolder.indicator.setVisibility(View.GONE);
					}
				} else {
					viewHolder.time.setTextColor(Color.parseColor("#1d85ea"));
					viewHolder.time.setTypeface(null, Typeface.ITALIC);
					if (message.getStatus() == Message.STATUS_SEND_RECEIVED) {
						//Log.d("SPEAKY", "MESSAGE RECEIVED");
						viewHolder.indicator.setVisibility(View.VISIBLE);
			...
			// private void displayTextMessage(ViewHolder viewHolder, String
			// text) {
			private void displayTextMessage(ViewHolder viewHolder,
				...
				viewHolder.messageBody
						.setOnLongClickListener(new OnLongClickListener() {
							...
							public boolean onLongClick(View v) {
								String[] messageOptions = getResources()
										.getStringArray(
								...
								builder.setItems(messageOptions,
											...
											public void onClick(
												...
												case 1:
													...
													activity.xmppConnectionService
															.deleteSingleMessage(
																	message,
																	activity.getSelectedConversation());
													break;
												case 2:
				...
				viewHolder.image
						.setOnLongClickListener(new OnLongClickListener() {
							...
							public boolean onLongClick(View v) {
								String[] messageOptions = getResources()
										.getStringArray(
												R.array.image_options_menu_items);

								AlertDialog.Builder builder = new AlertDialog.Builder(
										getActivity());
								builder.setTitle(getString(R.string.image_options_menu_title));
								builder.setItems(messageOptions,
										new DialogInterface.OnClickListener() {
											@Override
											public void onClick(
	...
	// final ConversationActivity activity = (ConversationActivity)
	// getActivity();
	...
	private static class ViewHolder {
		...
		protected ImageView security_indicator;
